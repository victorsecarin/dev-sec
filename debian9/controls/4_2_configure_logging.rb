...
control 'cis-dil-benchmark-4.2.2.1' do
  title 'Ensure syslog-ng is Enabled'
  desc  "The syslog-ng software is recommended as a replacement for the syslogd daemon and
...
control 'cis-dil-benchmark-4.2.2.2' do
  title 'Ensure syslog-ng ogging is configured'
  desc  '
...
control 'cis-dil-benchmark-4.2.2.3' do
  ...
  desc  '
    syslog-ng will create logfiles that do not already exist on the system. This setting controls what permissions will be applied to
    these newly created files.
