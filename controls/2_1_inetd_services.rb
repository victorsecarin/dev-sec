...
control 'cis-dil-benchmark-2.1.2' do
  title 'Ensure openbsd-inet is not installed'
  desc  "The inetd daemon listens for well known services and dispatches the appropriate daemon
to properly respond to service requests.If there are no inetd services required, it is recommended that the daemon be removed."
  impact 1.0

  tag cis: 'Debian9:2.1.2'
  tag level: 1
